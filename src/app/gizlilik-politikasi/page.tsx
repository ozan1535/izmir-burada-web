...
export default function page() {
  return (
    <>
      <Head>
        <title>Gizlilik Politikası | Izmir Burada </title>
        <meta
          name="description"
          content="izmir-burada.com gizlilik politikası"
        />
      </Head>
      <main className="max-w-3xl mx-auto px-4 py-10 mt-16">
        ...
        <p className="mb-4">
          <strong>izmir-burada.com</strong> olarak ziyaretçilerimizin
          gizliliğine önem veriyoruz. Bu Gizlilik Politikası, web sitemizi
          ziyaret ettiğinizde hangi bilgilerin toplandığını, bu bilgilerin nasıl
          kullanıldığını ve korunduğunu açıklar.
        </p>

        <h2 className="text-xl font-semibold mt-6 mb-2">1. Toplanan Veriler</h2>
        <p className="mb-4">
          izmir-burada.com, kullanıcıların kişisel bilgilerini doğrudan
          toplamaz. Ancak, web sitemizi geliştirmek ve kullanıcı deneyimini
          iyileştirmek amacıyla <strong>Google Analytics</strong> hizmetinden
          yararlanıyoruz.
        </p>
        <p className="mb-4">
          Google Analytics, ziyaretçi etkileşimlerini analiz etmek için
          çerezleri (cookies) kullanır. Bu veriler arasında şunlar yer alabilir:
        </p>
        ...
        <p className="mb-4">
          Toplanan veriler, üçüncü taraflarla{" "}
          <strong>paylaşılmamaktadır</strong>. Sadece Google Analytics ile
          sınırlı olan bu veriler, Google’ın kendi gizlilik politikaları
